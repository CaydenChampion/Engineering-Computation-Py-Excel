...
# Approximate the derivative of a function at a single point or across many points
...
# Approximate the drivative at a point 
xi = 3.5
dx = .5
...
# Print results
print("\n The forward difference appproximation of the")
print(f"slope of the function at x = {xi} is {slope_forward}")
print("\n The backward difference appproximation of the")
print(f"slope of the function at x = {xi} is {slope_backward}")
print("\n The centered difference appproximation of the")
